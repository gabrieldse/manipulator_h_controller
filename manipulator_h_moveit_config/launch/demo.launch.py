...
def generate_launch_description():
    ...
    rviz_config = PathJoinSubstitution(
        [FindPackageShare("manipulator_h_moveit_config"), "config", rviz_base]
    )
    ...
    # Log the path to the controllers file
    log_ros2_controllers_path = LogInfo(msg=f"ros2_controllers_path: {ros2_controllers_path}")
    ...
    arm_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["manipulator_h_arm_controller", "-c", "/controller_manager"],
    )
